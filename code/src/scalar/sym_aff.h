...
// abandoned -> no significant speedup

// use exponential function approximation, based on SCALAR_UP1
// #define SYM_AFF_PA_SCALAR_UP3
...
// Replace the 'expf' function call by an approximation, based on up1
